<section class="content-header">
    <h1>Laporan Data<small>&nbsp;Sewa</small></h1>
    <ol class="breadcrumb">
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><b>Laporan</b>&nbsp;Data&nbsp;Sewa</h3>
        </div>
        <div class="container">
        <a href="<?= base_url('laporan-sewa/download-laporan') ?>" target="_blank" class="btn btn-warning"><i class="fa fa-file"></i>Download Semua</a>
        </div>
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td style="width: 500px;">
                            <a href="<?= site_url('download/download-'.$data->id_detail_sewa)?>" target="_blank" class="btn btn-primary"><i class="fa fa-pencil"></i>&nbsp;Download PDF</a>
